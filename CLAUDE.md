...
167 field-tested techniques for Claude Code, organized into five parts. When the user asks about Claude Code workflows, patterns, or best practices, search these files for relevant techniques. Reference techniques by title.
...
- `PART2-TECHNIQUES.md` — Part 2: 143 techniques in 16 categories (index table at top for scanning)
